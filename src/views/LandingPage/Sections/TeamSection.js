        ...
        <GridContainer>
            ...
            <Card plain>
              ...
              <CardBody>
                <p className={classes.description}>
                  ...
                  also the Drummer, said he named it because the songs we
                  perform were in the Zenith time period from which they
                  originate.
                </p>
              </CardBody>
          ...
          <GridItem xs={12} sm={12} md={6}>
            <Card plain>
              ...
              <CardBody>
                <p className={classes.description} styles={{ fontSize: "2em" }}>
